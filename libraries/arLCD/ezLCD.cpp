 ...
 */
  ...
  * Updated to v1.01 4/4/2013 'fixed isPressed function
  * Updated to v1.02 7/3/2013 added sendCommand to se direct commands to LCD and updated refman.pdf
  * Ken Segler EarthLCD
  */
...
unsigned int EzLCD3::wstate( int id, int state )
{
    sdebug( "\ntx:WValue ");
    sendGPUCmd( Widget_State, id ,state );
//    unsigned int ret =  m_pStream->parseInt() ;
