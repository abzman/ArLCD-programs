...
// Adds defines for graphics primitives similar to Processing and GLCD
     ...
     * \param[in]  option    Options 1=draw, 2=disabled, 3=toggle pressed,<BR>
     *                               4=toggle not pressed, 5=toggle pressed disabled,<BR>
     *                               6=toggle not pressed disabled 
     */
     ...
     * \param[in]  width     Width in pixels.
     * \param[in]  height    Height in pixels.
     * \param[in]  option    Options 1=enable, 2=disabled    
     */
     ...
     * \param[in]  width     Width in pixels.
     * \param[in]  height    Height in pixels.
     * \param[in]  option    Options 1=draw, 2=disabled, 3=checked, 4=first, 5=first&checked <BR>
     * FIRST means first button in the group for radio buttons since only one button can be checked in a group. <BR>
     * A new group will begin when another “first” radio button is made.
     */
     ...
     * \param[in]  width     Width in pixels.
     * \param[in]  height    Height in pixels.
     * \param[in]  option    Options determines the header alignments. (The options do not affect the contents' alignment)<BR>
     ...
     *                         Default is \c 100.
     * \param[in]  option      Options 1=horizontal, 2=horizontal disabled, 3=vertical, 4= vertical disabled, 5=redraw bar
     ...
     * \param[in]  width     Width in pixels.
     * \param[in]  height    Height in pixels.
     * \param[in]  option    Options 1=left, 2=disabled, 3=right, <BR>
     *                               4=center, 5=left framed, 6=disabled framed, <BR>
     *                               7=right framed, 8=center framed, 9=redraw  <BR>
     */
     ...
     * \param[in]  option    Options 1=left, 2=disabled, 3=right, 4=center,<BR>
     *                               11=left framed, 12=disable framed,<BR>
     ...
     * \param[in]  option    Options 1=draw, 2=disabled, 3=ring, 4=accuracy<BR>
     *                          Draw prints the widget to screen.<BR>
     *                          Disabled draws a widget that can no be affected or changed.<BR>
     *                          Ring draws the widget with an arc'ed bar around numbers.<BR>
     *                          Accuracy allows you to display numbers with a decimal point for more exact numbers. <BR>
     * \param[in]  type      type  0=full, 1=half, 2=quarter
     */
     ...
     * \param[in]  width       Width in pixels.
     * \param[in]  height      Height in pixels.
     * \param[in]  resolution  increments or step size the indicator will move along the bar. <BR>
     *                          ex. 'max' = 20 and 'resolution' =  5, <BR>
     *                          then the indicator can only be values 0, 5, 10, 15, 20.
     * \param[in]  initial     Initial numeric value of the slider. 
     * \param[in]  max         Maximum numeric value of the slider. 
     * \param[in]  option      Options 1=draw horizontal, 2=horizontal disabled, <BR> 
     *                                 3=vertical, 4=vertical disabled,    <BR>
     *                                  5=horizontal sliderscrollbar, <BR>
     *                                  6=horizontal sliderscrollbar disabled, <BR>
     *                                  7=vertical sliderscrollbar, <BR>
     *                                  8=vertical sliderscrollbar disabled <BR>
     */
     ...
     *             <BR>colors of its corresponding interval in the analog meter
     */
     ...
     */    
    unsigned int wstate( int id, int state );
    /**
    ...
    * \param[in]  str    string direct command <BR> sendCommand("cls"); clear screen
    *
    */
